...
export function ScootixLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function GuaranteeIcon(props: SVGProps<SVGSVGElement>) {
  return (
...
export function DiyKitIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
